...
public class KabalBullet2 : MonoBehaviour {
    ...
    private void Update() {
        //Ground
        isGround = Physics2D.Linecast(transform.position, ground.position, 1 << 8);
        Debug.DrawLine(transform.position, ground.position, Color.red);
