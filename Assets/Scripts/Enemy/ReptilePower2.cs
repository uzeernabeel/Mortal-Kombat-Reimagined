...
public class ReptilePower2 : MonoBehaviour {
    ...
    void Update() {
        ...
        if (time > bulletTime && !gotHitFirstTime) {
            ...
            if (moveRight) {
                barakaPowerPrefab.GetComponent<ReptileBullet2>().facingLeft = false;
                //Debug.Log("Some how I ended up here!");
            } else {
                barakaPowerPrefab.GetComponent<ReptileBullet2>().facingLeft = true;
