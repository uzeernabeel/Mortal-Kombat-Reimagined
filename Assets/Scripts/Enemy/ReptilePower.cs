...
public class ReptilePower : MonoBehaviour {
    ...
    void Update() {
        ...
        if (time > bulletTime && !gotHitFirstTime) {
            ...
            if (moveRight) {
                barakaPowerPrefab.GetComponent<ReptileBullet>().facingLeft = false;
                //Debug.Log("Some how I ended up here!");
            } else {
                barakaPowerPrefab.GetComponent<ReptileBullet>().facingLeft = true;
